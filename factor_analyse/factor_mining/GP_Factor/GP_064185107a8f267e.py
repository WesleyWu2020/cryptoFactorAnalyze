"""Exported GP factor GP_064185107a8f267e.
...
META = {"factor_name": "GP_064185107a8f267e", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_064185107a8f267e (expression 064185107a8f267e818c0432cf3aa2e479ba8fbd31cda3079ff795365192e043)'}

_EXPRESSION_HASH = "064185107a8f267e818c0432cf3aa2e479ba8fbd31cda3079ff795365192e043"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 10, 'children': [{'op': 'rolling_mean', 'field': None, 'window': 10, 'children': [{'op': 'rolling_std', 'field': None, 'window': 60, 'children': [{'op': 'rolling_max', 'field': None, 'window': 40, 'children': [{'op': 'range_relative', 'field': None, 'window': None, 'children': []}]}]}]}]}

SETTING = {"data_needed": ['close', 'high', 'low'], "universe": "historical_top50",
           "warmup_bars": 116, "preprocessing": "none",
