"""Exported GP factor GP_77282e814dac81a8.
...
META = {"factor_name": "GP_77282e814dac81a8", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_77282e814dac81a8 (expression 77282e814dac81a8bc35a65b4b7e8c3b029d6f0426e836a3911b07f4a230cf94)'}

_EXPRESSION_HASH = "77282e814dac81a8bc35a65b4b7e8c3b029d6f0426e836a3911b07f4a230cf94"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 10, 'children': [{'op': 'rolling_median', 'field': None, 'window': 60, 'children': [{'op': 'rolling_max_drawdown', 'field': None, 'window': 40, 'children': [{'op': 'trade_count', 'field': None, 'window': None, 'children': []}]}]}]}

SETTING = {"data_needed": ['trade_count'], "universe": "historical_top50",
           "warmup_bars": 107, "preprocessing": "none",
