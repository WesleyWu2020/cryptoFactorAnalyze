"""Exported GP factor GP_0006a47b612eaf9b.
...
META = {"factor_name": "GP_0006a47b612eaf9b", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_0006a47b612eaf9b (expression 0006a47b612eaf9b8943a0fc7b91506c5c095a3258cfa8f9c6390e876f7a468a)'}

_EXPRESSION_HASH = "0006a47b612eaf9b8943a0fc7b91506c5c095a3258cfa8f9c6390e876f7a468a"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 60, 'children': [{'op': 'rolling_max', 'field': None, 'window': 60, 'children': [{'op': 'rolling_min', 'field': None, 'window': 20, 'children': [{'op': 'rolling_max', 'field': None, 'window': 5, 'children': [{'op': 'return_1d', 'field': None, 'window': None, 'children': []}]}]}]}]}

SETTING = {"data_needed": ['close'], "universe": "historical_top50",
           "warmup_bars": 142, "preprocessing": "none",
