"""Exported GP factor GP_344ff595295f111b.
...
META = {"factor_name": "GP_344ff595295f111b", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_344ff595295f111b (expression 344ff595295f111b2e67b6dfc64f989ac81edae0f96ba27078f86f97014414b3)'}

_EXPRESSION_HASH = "344ff595295f111b2e67b6dfc64f989ac81edae0f96ba27078f86f97014414b3"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 60, 'children': [{'op': 'rolling_std', 'field': None, 'window': 10, 'children': [{'op': 'rolling_max', 'field': None, 'window': 5, 'children': [{'op': 'range_relative', 'field': None, 'window': None, 'children': []}]}]}]}

SETTING = {"data_needed": ['close', 'high', 'low'], "universe": "historical_top50",
           "warmup_bars": 72, "preprocessing": "none",
