"""Exported GP factor GP_3eaff470cdb222f5.
...
META = {"factor_name": "GP_3eaff470cdb222f5", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_3eaff470cdb222f5 (expression 3eaff470cdb222f5823e211e79b0cbc933fe2bdd349b60b83aec5fd4981814b8)'}

_EXPRESSION_HASH = "3eaff470cdb222f5823e211e79b0cbc933fe2bdd349b60b83aec5fd4981814b8"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 20, 'children': [{'op': 'rolling_mean', 'field': None, 'window': 40, 'children': [{'op': 'taker_quote_ratio', 'field': None, 'window': None, 'children': []}]}]}

SETTING = {"data_needed": ['quote_volume', 'taker_buy_quote_volume'], "universe": "historical_top50",
           "warmup_bars": 58, "preprocessing": "none",
