"""Exported GP factor GP_7008d7895cac50bb.
...
META = {"factor_name": "GP_7008d7895cac50bb", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_7008d7895cac50bb (expression 7008d7895cac50bbe446adc4d9297f3cdaf856ba7e70160cf767ea68df1d2b89)'}

_EXPRESSION_HASH = "7008d7895cac50bbe446adc4d9297f3cdaf856ba7e70160cf767ea68df1d2b89"
...
_AST = {'op': 'rolling_std', 'field': None, 'window': 40, 'children': [{'op': 'rolling_std', 'field': None, 'window': 60, 'children': [{'op': 'quote_per_trade', 'field': None, 'window': None, 'children': []}]}]}

SETTING = {"data_needed": ['quote_volume', 'trade_count'], "universe": "historical_top50",
           "warmup_bars": 98, "preprocessing": "none",
