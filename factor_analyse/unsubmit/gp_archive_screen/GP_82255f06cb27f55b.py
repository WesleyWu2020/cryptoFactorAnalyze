"""Exported GP factor GP_82255f06cb27f55b.
...
META = {"factor_name": "GP_82255f06cb27f55b", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_82255f06cb27f55b (expression 82255f06cb27f55bd393dcc857623403044f9ed4872015f44ea6452a67352e78)'}

_EXPRESSION_HASH = "82255f06cb27f55bd393dcc857623403044f9ed4872015f44ea6452a67352e78"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 40, 'children': [{'op': 'rolling_std', 'field': None, 'window': 60, 'children': [{'op': 'body_relative', 'field': None, 'window': None, 'children': []}]}]}
