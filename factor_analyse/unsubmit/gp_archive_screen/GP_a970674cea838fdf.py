"""Exported GP factor GP_a970674cea838fdf.
...
META = {"factor_name": "GP_a970674cea838fdf", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_a970674cea838fdf (expression a970674cea838fdf1ad7a6a732ef6e3e1ebc84556a168919c58e573809e76df0)'}

_EXPRESSION_HASH = "a970674cea838fdf1ad7a6a732ef6e3e1ebc84556a168919c58e573809e76df0"
...
_AST = {'op': 'rolling_mean', 'field': None, 'window': 20, 'children': [{'op': 'rolling_mean', 'field': None, 'window': 5, 'children': [{'op': 'rolling_std', 'field': None, 'window': 60, 'children': [{'op': 'range_relative', 'field': None, 'window': None, 'children': []}]}]}]}

SETTING = {"data_needed": ['close', 'high', 'low'], "universe": "historical_top50",
           "warmup_bars": 82, "preprocessing": "none",
