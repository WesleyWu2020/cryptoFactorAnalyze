"""Exported GP factor GP_260212412430b0ed.
...
META = {"factor_name": "GP_260212412430b0ed", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_260212412430b0ed (expression 260212412430b0ed7346e40dfe8c3b7fba45aba06300183d441cb3e15a2bfed2)'}

_EXPRESSION_HASH = "260212412430b0ed7346e40dfe8c3b7fba45aba06300183d441cb3e15a2bfed2"
...
_AST = {'op': 'rolling_min', 'field': None, 'window': 10, 'children': [{'op': 'safe_div', 'field': None, 'window': None, 'children': [{'op': 'rolling_min', 'field': None, 'window': 60, 'children': [{'op': 'trade_count', 'field': None, 'window': None, 'children': []}]}, {'op': 'quote_per_trade', 'field': None, 'window': None, 'children': []}]}]}

SETTING = {"data_needed": ['quote_volume', 'trade_count'], "universe": "historical_top50",
           "warmup_bars": 68, "preprocessing": "none",
