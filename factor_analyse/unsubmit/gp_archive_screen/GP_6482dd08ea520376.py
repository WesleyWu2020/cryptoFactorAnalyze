"""Exported GP factor GP_6482dd08ea520376.
...
META = {"factor_name": "GP_6482dd08ea520376", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_6482dd08ea520376 (expression 6482dd08ea5203761ea3a7f3b3bf39a1e911e83ebe19da5f9d1a9841694d9eed)'}

_EXPRESSION_HASH = "6482dd08ea5203761ea3a7f3b3bf39a1e911e83ebe19da5f9d1a9841694d9eed"
...
_AST = {'op': 'rolling_min', 'field': None, 'window': 40, 'children': [{'op': 'lag', 'field': None, 'window': 1, 'children': [{'op': 'rolling_std', 'field': None, 'window': 5, 'children': [{'op': 'quote_per_trade', 'field': None, 'window': None, 'children': []}]}]}]}

SETTING = {"data_needed": ['quote_volume', 'trade_count'], "universe": "historical_top50",
           "warmup_bars": 44, "preprocessing": "none",
