"""Exported GP factor GP_9bcbe8613fe91402.
...
META = {"factor_name": "GP_9bcbe8613fe91402", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_9bcbe8613fe91402 (expression 9bcbe8613fe914023d9139ca7068fb0ddc98f5ab5b4fc86fffcb7898810fe096)'}

_EXPRESSION_HASH = "9bcbe8613fe914023d9139ca7068fb0ddc98f5ab5b4fc86fffcb7898810fe096"
...
_AST = {'op': 'multiply', 'field': None, 'window': None, 'children': [{'op': 'rolling_mean', 'field': None, 'window': 60, 'children': [{'op': 'range_relative', 'field': None, 'window': None, 'children': []}]}, {'op': 'rolling_mean', 'field': None, 'window': 20, 'children': [{'op': 'rolling_mean', 'field': None, 'window': 5, 'children': [{'op': 'range_relative', 'field': None, 'window': None, 'children': []}]}]}]}

SETTING = {"data_needed": ['close', 'high', 'low'], "universe": "historical_top50",
           "warmup_bars": 59, "preprocessing": "none",
