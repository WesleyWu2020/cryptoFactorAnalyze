"""Exported GP factor GP_213d40636430a461.
...
META = {"factor_name": "GP_213d40636430a461", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_213d40636430a461 (expression 213d40636430a461188900566b159229724c2afef0a76a48e85ad3b2739b94ec)'}

_EXPRESSION_HASH = "213d40636430a461188900566b159229724c2afef0a76a48e85ad3b2739b94ec"
...
_AST = {'op': 'rolling_std', 'field': None, 'window': 60, 'children': [{'op': 'delta', 'field': None, 'window': 3, 'children': [{'op': 'rolling_max', 'field': None, 'window': 60, 'children': [{'op': 'rolling_min', 'field': None, 'window': 10, 'children': [{'op': 'quote_per_trade', 'field': None, 'window': None, 'children': []}]}]}]}]}

SETTING = {"data_needed": ['quote_volume', 'trade_count'], "universe": "historical_top50",
           "warmup_bars": 130, "preprocessing": "none",
