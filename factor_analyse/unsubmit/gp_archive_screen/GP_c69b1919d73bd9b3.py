"""Exported GP factor GP_c69b1919d73bd9b3.
...
META = {"factor_name": "GP_c69b1919d73bd9b3", "author": "genetic_algorithm",
        "level": "daily", "category": "gp",
        "description": 'GP export GP_c69b1919d73bd9b3 (expression c69b1919d73bd9b30e84c64b83ac6077c622e9fa6bead918a61baa9233d20be1)'}

_EXPRESSION_HASH = "c69b1919d73bd9b30e84c64b83ac6077c622e9fa6bead918a61baa9233d20be1"
...
_AST = {'op': 'lag', 'field': None, 'window': 3, 'children': [{'op': 'rolling_max', 'field': None, 'window': 40, 'children': [{'op': 'rolling_corr', 'field': None, 'window': 10, 'children': [{'op': 'low', 'field': None, 'window': None, 'children': []}, {'op': 'low', 'field': None, 'window': None, 'children': []}]}]}]}

SETTING = {"data_needed": ['low'], "universe": "historical_top50",
           "warmup_bars": 51, "preprocessing": "none",
